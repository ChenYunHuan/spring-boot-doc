...
public class SettingController {
    ...
    public @ResponseBody
    Result password(String password, String newPassword, HttpServletRequest request) {
        logger.info("用户登陆 ");
    ...
    public @ResponseBody
    Result modfiyUser(String email, String phone, String description, HttpServletRequest request) {
        logger.info("修改用户信息 ");
        Member member = (Member) request.getSession().getAttribute(Constans.CURRENT_USER);
        Result result = new Result();
