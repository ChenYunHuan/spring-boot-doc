...
public class AccountController {
    ...
    public @ResponseBody
    Result login(Member member, String code, HttpServletRequest request) {
    ...
    public @ResponseBody
    Result register(Member member, String code, HttpServletRequest request) {
        Result result = new Result();
        logger.info("用户注册 ");
        Member user = memberRepository.findByAccount(member.getAccount());
        String vrifyCode = (String) request.getSession().getAttribute("vrifyCode");
    ...
    public @ResponseBody
    Result findPassword(String email, String code, HttpServletRequest request) {
